...
//    private String operHourHolS;
    ...
    @Builder
    @QueryProjection
    public HospitalEsEntity(String id, String orgId, String addr, String hosCate, String hosCateNm, String fstAidMedicInsCd, String fstAidMedicInsNm, String edOperYn, String etc, String operDescDt, String operNm, String phone1, String edPhone, String zipCode1, String zipCode2) {
        this.id = id;
        this.orgId = orgId;
        this.addr = addr;

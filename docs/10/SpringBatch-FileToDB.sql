...
where I1.JOB_NAME = 'batch_FILE_TO_TMP'
  and I1.JOB_INSTANCE_ID in (SELECT max(I2.JOB_INSTANCE_ID) from BATCH_JOB_INSTANCE I2 where I2.JOB_NAME = 'batch_FILE_TO_TMP');
...
FROM BATCH_JOB_INSTANCE
WHERE 1 = 1
  AND JOB_NAME = 'batch_FILE_TO_TMP'
...
FROM BATCH_JOB_EXECUTION
WHERE 1 = 1
  AND JOB_INSTANCE_ID = 709;
# 7.
INSERT into BATCH_JOB_EXECUTION (JOB_EXECUTION_ID, JOB_INSTANCE_ID, START_TIME, END_TIME, STATUS, EXIT_CODE, EXIT_MESSAGE, VERSION, CREATE_TIME,
...
SELECT JOB_EXECUTION_ID, COUNT(1)
FROM BATCH_JOB_EXECUTION_PARAMS
...
INSERT into BATCH_JOB_EXECUTION_PARAMS(JOB_EXECUTION_ID, KEY_NAME, TYPE_CD, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL, IDENTIFYING)
values (?, ?, ?, ?, ?, ?, ?, ?);
...
ORDER BY 1 DESC;
# 9. 실행 context ?
INSERT INTO BATCH_JOB_EXECUTION_CONTEXT (SHORT_CONTEXT, SERIALIZED_CONTEXT, JOB_EXECUTION_ID)
VALUES (?, ?, ?);
...
# 17.
INSERT into BATCH_STEP_EXECUTION (STEP_EXECUTION_ID, VERSION, STEP_NAME, JOB_EXECUTION_ID, START_TIME, END_TIME, STATUS, COMMIT_COUNT, READ_COUNT,
...
# 18.
INSERT INTO BATCH_STEP_EXECUTION_CONTEXT (SHORT_CONTEXT, SERIALIZED_CONTEXT, STEP_EXECUTION_ID)
VALUES (?, ?, ?)

...
public class TmpToMultiDbStep {
    ...
    @Bean(name = STEP_NAME + "_DB_STEP")
    public Step tmpToMultiDbStep() {
        return stepBuilderFactory.get(STEP_NAME + "_DB_STEP")
    ...
    @Bean(name = STEP_NAME + "_DB_STEP_READER")
    ...
    /* Jpa Writer: City */
    @Bean(name = STEP_NAME + "_DB_STEP_CITY_WRITER")
    ...
    @Bean(name = STEP_NAME + "_DB_STEP_COUNTRY_WRITER")
    ...
    @Bean(name = STEP_NAME + "_DB_STEP_LIBRARY_WRITER")
